...
@unittest.skipIf(
    _IS_CI and not _RUN_LIVE,
    "Requires local GPU cluster endpoints (skipped on cloud CI unless AIDER_FACTORY_LIVE_CLOUD_E2E=1)",
)
class TestE2EPipeline(unittest.TestCase):
    def test_e2e_pipeline_smoke(self):
        print("==================================================")
        ...
        _cnames = code_db.list_tables() if hasattr(code_db, "list_tables") else code_db.table_names()
        code_tables = list(getattr(_cnames, "tables", _cnames))
