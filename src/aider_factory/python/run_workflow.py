...
for phase_idx, phase in enumerate(config.get("phases", [])):
    ...
    if phase_run_ocr_rag:
        ocr_ingest = {
            ...
            "chunk_size_chars": int(rag_phase_cfg.get("chunk_size_chars", rag_chunk_size)),
            "chunk_overlap_chars": int(rag_phase_cfg.get("chunk_overlap_chars", rag_chunk_overlap)),
            "code_chunk_size": int(rag_phase_cfg.get("code_chunk_size", rag_code_chunk)),
            ...
            "cer_threshold": float(rag_phase_cfg.get("cer_threshold", rag_cer_threshold)),
            "ocr_max_retries": int(rag_phase_cfg.get("ocr_max_retries", rag_ocr_max_retries)),
